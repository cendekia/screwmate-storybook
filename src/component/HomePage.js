  ...
  return (
    <div className="h-full">
      <div className="w-full container mx-auto">
        <div className="w-full flex items-center justify-between">
          <a className="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
            Screw<span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500">mate</span>
          </a>
      ...
      <div className="container pt-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
          ...
          <form className="bg-gray-900 opacity-75 w-full shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
            <div className="mb-4">
              ...
              />
              <label className="block text-blue-300 py-2 text-xs mb-2" for="emailaddress">
        ...
        <div className="w-full xl:w-3/5 p-12 relative" style={{ height: '600px' }}>
          ...
          {/* meeting table */}
          <img src="characters/purple.png" className="absolute top-0 -right-24" style={{ transform: `rotateY(180deg)` }} />
          <img src="characters/pink.png" className="absolute top-0 right-8" style={{ transform: `rotateY(180deg)` }} />
          <img src="characters/red.png" className="absolute top-0 -left-24" />
          <img src="characters/green.png" className="absolute top-0" />
          <img src="signs/voted.png" className="absolute top-0" />
        </div>
